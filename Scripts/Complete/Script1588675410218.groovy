...
WebUI.comment('Start and Complete Last Stage')
...
WebUI.verifyElementVisible(findTestObject('Page_KSJ_Encore/td_SubJob_Complete'), FailureHandling.STOP_ON_FAILURE)
